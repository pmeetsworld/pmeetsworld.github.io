...
function BackHeader({ onBack, title, subtitle, color }) {
  return h('div', { className: 'rm-header row', style: { background: color || APP_CHARCOAL, gap: 12 } },
      ...
      if (this.state.error) {
        return React.createElement('div', { style: { padding: 20, fontFamily: 'system-ui' } },
          ...
          React.createElement('button', {
            style: { padding: '10px 20px', background: APP_CHARCOAL, color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer', fontSize: 14 },
